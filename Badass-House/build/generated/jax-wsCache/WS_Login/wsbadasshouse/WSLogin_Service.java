 ...
 * 
 */
@WebServiceClient(name = "WS_Login", targetNamespace = "http://WSBadassHouse/", wsdlLocation = "http://localhost:8181/WebServices/WS_Login?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8181/WebServices/WS_Login?wsdl");
