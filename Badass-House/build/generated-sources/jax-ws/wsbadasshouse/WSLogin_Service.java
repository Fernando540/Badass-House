 ...
 * 
 */
@WebServiceClient(name = "WS_Login", targetNamespace = "http://WSBadassHouse/", wsdlLocation = "http://badasshouse.net23.net/WebServices/WS_Login?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://badasshouse.net23.net/WebServices/WS_Login?wsdl");
