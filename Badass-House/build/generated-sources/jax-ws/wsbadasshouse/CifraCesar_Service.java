 ...
 * 
 */
@WebServiceClient(name = "CifraCesar", targetNamespace = "http://WSBadassHouse/", wsdlLocation = "http://localhost:8181/WebServices/CifraCesar?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8181/WebServices/CifraCesar?wsdl");
